...
/**
 * SETTINGSTUTORIAL CLASS <br>
 * <br>
 * Creates a panel to hold settings tutorial <br>
 * <br>
 * 
 * @author Thomas Ma
 * @author Jenish Paudel
 */
public class SettingsTutorial extends JPanel {
	...
	/**
	 * SETTINGSTUTORIAL CONSTRUCTOR <br>
	 * <br>
	 * Creates the settings tutorial screen
	 * 
	 * @param inputFrame The program frame
	 * @param prevPanel  The previous game screen
	 */
	public SettingsTutorial(JFrame inputFrame, TutorialMain prevPanel) {
		...
		ImageIcon backgroundImage = new ImageIcon("src/images/settingsTut.png");
